        ...
        <div class="py-12">
            <div class="relative max-w-7xl sm:px-4 grid grid-cols-1 md:grid-cols-5 gap-x-6">
                ...
                <div class="hidden sticky top-0 md:top-32 right-0 md:block md:col-span-1 h-fit px-4 py-4 text-xs xl:text-sm bg-gray-50 rounded-md shadow-sm">
                    ...
                    <button class="my-2 p-1.5 px-3 text-slate-100 rounded hover:underline hover:bg-slate-900 bg-slate-700 transition-all 300ms ease-in-out">Add New</button>
                ...
                <div class="col-span-1 sm:col-span-2 md:col-span-4 bg-gray-50 grid gap-x-4">
                    ...
                    <div class="pb-3 bg-white rounded">
                        ...
                        <div class="grid grid-cols-3 md:grid-cols-4 gap-1 p-1">
                            ...
                            <a href="/grocery"
                               ...
                               <span class="my-auto h-fit px-1.5 font-semibold bg-opacity-50 rounded-lg">Groceries</span>
                            </a>
                            ...
                            <a href="/fashion"
                               ...
                               <span class="my-auto h-fit px-1.5 font-semibold bg-opacity-50 rounded-lg">Fashion</span>
                            </a>

                            <a href="/computing"
                               class="rounded bg-slate-800 hover:scale-[1.009] max-w-[260px] max-h-[144px] min-w-fit  min-h-[80px] bg-no-repeat bg-center bg-cover text-white text-center flex place-content-center shadow-sm">
                               <span class="my-auto h-fit px-1.5 font-semibold bg-opacity-50 rounded-lg">Computing</span>
                            </a>

                            <a href="/phones-and-tablets"
                               class="rounded bg-slate-800 hover:scale-[1.009] max-w-[260px] max-h-[144px] min-w-fit  min-h-[80px] bg-no-repeat bg-center bg-cover text-white text-center flex place-content-center shadow-sm">
                               <span class="my-auto h-fit px-1.5 font-semibold bg-opacity-50 rounded-lg">Phones</span>
                            </a>
