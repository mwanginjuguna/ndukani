<template>
    <AppLayout>
        <section class="mx-auto mt-12 max-w-2xl py-10 px-5 bg-white rounded shadow-md relative">
            <div class="py-3 px-2 sticky top-20 border-b">
                <p class="text-slate-700 text-xl text-center font-bold">You Have <span class="text-amber-900">{{ cartItemsNumber }}</span>  Items in Cart</p>
            </div>
            ...
            <div class="mt-3 text-sm">
                ...
                <div class="mt-10 py-6 px-3 rounded-lg shadow-sm bg-slate-100">
                    <div class="flex justify-between">
                        ...
                        <button class="px-2 bg-amber-500 text-white text-lg rounded-lg shadow-lg">Check Out</button>
                    </div>
                </div>
            </div>
        </section>
