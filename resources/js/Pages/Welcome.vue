...
<template>
    ...
    <div class="relative min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div v-if="canLogin" class="w-full sm:sticky sm:top-0 sm:right-0 p-4 border-b bg-white text-right">
            ...
            <div class="sm:flex sm:justify-between text-sm">
        ...
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div class="mt-5 py-6 px-4 bg-white rounded">
                <div class="flex justify-between">
                    <h3 class="font-semibold text-lg text-slate-900">Last Viewed</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-x-1 font-light ">
                    ...
                    <div class="bg-slate-50 px-1 hover:bg-white hover:shadow-md hover:rounded">
                        ...
                        <p class="mt-1 font-semibold">$ 4,758</p>
                        <p class="text-xs text-gray-600 line-through">$ 5,676</p>
                    </div>

                    <div class="bg-slate-50 px-1 hover:bg-white hover:shadow-md hover:rounded">
                        <img :src="`https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/19/008686/1.jpg?2060`" alt="product">
                        <p class="h-6 mt-1 overflow-hidden">Samsung Blah Blah Pro Max XD HD YT MD</p>
                        <p class="mt-1 font-semibold">$ 4,758</p>
                        <p class="text-xs text-gray-600 line-through">$ 5,676</p>
                    </div>
                    ...
                    <div class="bg-slate-50 px-1 hover:bg-white hover:shadow-md hover:rounded">
                        <img :src="`https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/98/786019/1.jpg?4816`" alt="product">
                        <p class="h-6 mt-1 overflow-hidden">Samsung Blah Blah Pro Max XD HD YT MD</p>
                        <p class="mt-1 font-semibold">$ 4,758</p>
                        <p class="text-xs text-gray-600 line-through">$ 5,676</p>
                    </div>
                    ...
                    <div class="bg-slate-50 px-1 hover:bg-white hover:shadow-md hover:rounded">
                        <img :src="`https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/72/6495511/1.jpg?0970`" alt="product">
                        <p class="h-6 mt-1 overflow-hidden">Samsung Blah Blah Pro Max XD HD YT MD</p>
                        <p class="mt-1 font-semibold">$ 4,758</p>
                        <p class="text-xs text-gray-600 line-through">$ 5,676</p>
                    </div>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div class="md:col-span-2 md:flex md:flex-row gap-x-px md:gap-6 py-10 px-6 bg-green-500 text-white rounded shadow-md">
                        <div class="">
                            <img alt="phone-image" class="max-w-xs rounded-lg max-h-[36rem] object-cover" :src="`https://ke.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/59/786019/1.jpg?4815`">
                        </div>
                        <div class="md:my-auto">
                            <h3 class="font-bold text-black text-xl font-serif underline underline-offset-4">Nangos 103R</h3>
                            <div class="mt-2">
