...
<template>
    ...
    <div class="relative min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <!--footer-->
        <div class="mt-12 max-w-6xl mx-auto w-full grid grid-cols-3 gap-x-6 px-3 md:px-6 py-8 bg-slate-50 bg-opacity-50">
            ...
            <!--bottom bar-->
            <div class="md:col-span-3 flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                    <div class="flex items-center gap-4">
                        <a href="https://github.com/Francis-Kanothe/ndukani" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
