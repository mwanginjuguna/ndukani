        ...
        <DialogModal :closeable="true" :show="showCart">
            ...
            <template #title :class="`relative`">
                <div class="pt-3 px-2 flex justify-between sticky top-20">
                    ...
                    <button @click="showCart = false" class="text-sm text-slate-500 hover:cursor-pointer">Close</button>
                </div>
            </template>
            ...
            <template #footer>
                <div class="flex justify-between">
                    <button @click="showCart = false" class="text-sm text-slate-500 hover:text-slate-600 hover:underline pr-8 pt-2">
                        <span>Close</span>
                    </button>

                    <Link :href="route('products')" :class="`text-sm text-blue-500 hover:text-blue-600 hover:underline pr-6 pt-2`">
